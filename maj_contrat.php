...
if($_POST){
  ...
  $contrat->collaborateur = $_POST['collaborateur'];

	if($contrat->updateContrat()){
?>
<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Mise à jour réussie!</strong><a href="./pages/frais.php"></a>
</div>
...
<form method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="contrat" value='<?php echo $contrat->ref_contrat; ?>'>
  </div>
