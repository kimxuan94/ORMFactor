 ...
 -->          </h4>
          ...
          <div class="collapse" id="toggleDemo0" style="height: 0px;">
            <ul class="nav nav-list">
              <li><a href="../pages/dashboard.php" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed">
          <span class="glyphicon glyphicon-tasks"></span> Tableau de bord <span class="caret pull-right"></span>
          </a></li>
          <!-- <li><a href="../pages/alertes.php" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed">
...
<!--           <small>IOSDSV <span class="caret"></span></small>
 -->          </h4>
          ...
          <li><a href="../app/login/index.php" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed">
